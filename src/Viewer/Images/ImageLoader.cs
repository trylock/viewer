...
namespace Viewer.Images
{
    ...
    public class ImageLoader : IImageLoader
    {
        ...
        {
            var orientationAttr = entity.GetValue<IntValue>(ExifJpegSerializer.Orientation);
        ...
        {
            var widthAttr = entity.GetValue<IntValue>(ExifJpegSerializer.Width);
            var heightAttr = entity.GetValue<IntValue>(ExifJpegSerializer.Height);
        ...
        public Task<SKBitmap> LoadThumbnailAsync(IEntity entity, CancellationToken cancellationToken)
        {
            ...
            var orientation = GetTransformation(entity);
            var thumbnail = entity.GetValue<ImageValue>(ExifJpegSerializer.Thumbnail);
            if (thumbnail == null)
            {
